...
<ul>
	...
	<li>Run
		<pre>ifconfig</pre>
		command to find IP address of the virtual computer. Your use IP address for
...
If the computations are too slow, you may try to use virtual machine with <a
		href="http://user.mendelu.cz/marik/maw/download-old.php">older and faster software</a>.
...
texmacs-common latex-cjk-chinese latex-cjk-chinese-arphic-gbsn00lp latex-cjk-common dvipng build-essential mercurial
unzip). Z CTAN
...
<ul>
	...
	<li>Spusťte příkaz
		<pre>ifconfig</pre>
		abyste našli IP adresu virtuálního stroje.
...
Pokud jsou výpočty příliš pomalé, můžete použít virtuální počítač se <a
		href="http://user.mendelu.cz/marik/maw/download-old.php">starší ale rychlejší verzí programu Maxima</a>.
