...
<?php maw_before_form() ?>
<form name="exampleform" id="exampleform" <?php formmethod(); ?>
	<?php echo $onsubmit; ?>
			action="<?php
	  ...
	  <?php echo __("Curves on boundary"); ?>:
		...
		<table>
			...
			<?php echo __('Upper bound'); ?>:
				...
				<td><span style="font-style: italic;">f(x) =</span></td>
				<td>
			...
			<?php echo __('Lower bound'); ?>:
				...
				<td><span style="font-style: italic;">g(x) =</span></td>
				<td>
	...
	<fieldset class="vnitrni">
	  ...
	  <?php echo __('Bounds for the picture (decimal numbers)'); ?>
		...
		<span style="font-style: italic;">ymin =</span>&nbsp;<input name="ymin" value="<?php echo $ymin; ?>" size="15"
																																title="" id="in-ymin">
		&nbsp;&nbsp; <span style="font-style: italic;">&nbsp;ymax =</span> <input name="ymax" value="<?php echo $ymax; ?>"
																																							size="15" title="" id="in-xmax">
	</fieldset>
