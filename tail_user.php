...
if ($reqlang=="cs")
{
echo '<p style="text-align:right; margin:0pt; margin-top:5px;">Celý <a href="https://www.youtube.com/c/RobertMarik">Youtube kanál</a>.</p>';
echo '<p style="text-align:right; margin:0pt;">Web <a href="http://user.mendelu.cz/marik/mechmat">Mechanická matematika</a>.</p>';
}
else
{
echo '<p style="text-align:right;">The rest of the <a href="https://www.youtube.com/c/RobertMarik">Youtube chanel</a>.</p>';
}
}
