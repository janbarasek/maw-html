<span class="nadpis">
<?php echo __("Newton-Raphson method");

$function = $_REQUEST["function"];
if ($function == "") {
	$function = rawurldecode("2*x^2-cos(x)");
	$a = 0.5;
	$b = 1.1;
	$c = 1;
	$n = 10;
...
<form name="exampleform" id="exampleform"
	...
	<label for="funkce">
	  <?php {
		  echo __("Enter function, initial approximation and number of steps.");
	  } ?>
	</label>
	...
	<?php echo __("Interval for picture from ") ?>
