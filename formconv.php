...
Výraz: <img align="center" src="http://is.mendelu.cz/teximg.pl?x^{2}\, \mathrm{e}^{x^{2}}"/><br><br>Zápis programem
Maxima: <b>((x^23)*exp((x^2)))</b><br>
<br>
...
<form name="checkit">
	...
	<input type="button" value="Přenést do formuláře" onclick="updateit()">
</body>
</html>
